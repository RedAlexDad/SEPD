                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    <div class="mb-3">
                        <input
                            ...
                            name="schedule"
                            onChange={changeHandler} />
                        <label htmlFor="schedule"></label></div>
                </div>

                <div class="butt">
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button class="btn btn-warning" type="button"><Link to="/request_tasks">Показать все запросы</Link></button>

                        <button class="send request"
                            // Отправка запроса
                            onClick={registerHandler}
                            // Если загружается
                            disable={loading} >Отправить </button>

                        <button class="btn btn-warning" type="button"><Link to="/main">Назад</Link></button>
                    </div>
                </div>
            </main>
        </body>
