                    ...
                    <div class="form">
                        <form class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="validationDefault01" required placeholder="@" />
                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault02" class="form-label">Пароль</label>
                                <input type="password" class="form-control" id="validationDefault02" required placeholder="******"/>
                            </div>
                            <div class="col-12">
