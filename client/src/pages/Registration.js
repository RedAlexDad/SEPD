                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" required placeholder="name" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault03" class="form-label">Отечество</label>
                            ...
                            <div class="col-md-4">
                                <label for="validationDefault06" class="form-label">Пароль</label>
                                <input type="password" class="form-control" id="validationDefault06" required placeholder="******"/>
                            </div>
                            <div class="col-12">
